...
class TimeTracking(models.Model):
    activity = models.ForeignKey('Activity', related_name='time_trackings', on_delete=models.CASCADE)
    user = models.ForeignKey('User', related_name='time_trackings', on_delete=models.CASCADE)
    action = models.ForeignKey('Action', related_name='time_trackings', on_delete=models.CASCADE)
